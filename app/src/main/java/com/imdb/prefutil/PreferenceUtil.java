...
public class PreferenceUtil {
    ...
    public static final String GLOBAL_SHARED_PREF_NAME = "imdb_global_shared_pref";
    public static final String SHARED_PREF_NAME = "imdb_shared_pref";
    ...
    public static void setGlobalPref(Context context, String key, long value) {
        SharedPreferences appInstallInfoSharedPref = context.getSharedPreferences(GLOBAL_SHARED_PREF_NAME, Context.MODE_PRIVATE);
    ...
    public static boolean getGlobalPrefBoolean(Context context, String key) {
        SharedPreferences userAcountPreference = context.getSharedPreferences(GLOBAL_SHARED_PREF_NAME, Context.MODE_PRIVATE);
